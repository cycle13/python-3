...
out_obs_path='/home/ra001011/a03471/data/input_data/obs/QCED_1KM_v4_v500M_attn0.01_4D_1min/'  #Path were the new observation files will be stored.

ori_time_freq=30    #Original observation frequency in seconds.
out_time_freq=60   #Requested observation frequency in 4D output files.
