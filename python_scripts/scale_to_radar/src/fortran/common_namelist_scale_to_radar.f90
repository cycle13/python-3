...
WRITE(*,*)"DEBUG  : ",input_type,n_times
WRITE(*,*)"DEBUG  : ",reflectivity_error,radialwind_error
WRITE(*,*)"DEBUG  : ",method_ref_calc
...
ENDIF
REWIND(54)
WRITE(*,*)"DEBUG  : ",MPRJ_basepoint_lon,MPRJ_basepoint_lat
WRITE(*,*)"DEBUG  : ",MPRJ_type,MPRJ_LC_lat1,MPRJ_LC_lat2
