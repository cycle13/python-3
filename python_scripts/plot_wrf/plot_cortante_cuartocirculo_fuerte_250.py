...
wrf_data = wrf.get_data_vslice( data_path , slice_type='h' , slice_z = 5000.0 , zres=200.0 , force=False ) 
...
wrfp.plot_momentum_equation_v( wrf_data , plot_path , ybound=[20000,40000] , xbound=[30000,50000]  )
wrfp.plot_termo_equation_v( wrf_data , plot_path , ybound=[20000,40000] , xbound=[30000,50000] )
wrfp.plot_vapor_equation_v( wrf_data , plot_path , ybound=[20000,40000] , xbound=[30000,50000] )
wrfp.plot_water_equation_v( wrf_data , plot_path , ybound=[20000,40000] , xbound=[30000,50000] )
wrfp.plot_ppert_equation_v( wrf_data , plot_path , ybound=[20000,40000] , xbound=[30000,50000] )
