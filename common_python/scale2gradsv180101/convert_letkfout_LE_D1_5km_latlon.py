...
varout_3d = []  # variables for restart file
#varout_3d = ['u', 'v', 'w', 'p', 'tk', 'theta', 'z', 'qv', 'qc', 'qr', 'qi', 'qs', 'qg', 'qhydro', 'rh', 'dbz']                                   # variables for history file
varout_2d = ['glon','glat','topo']                                                                     # variables for restart file
...
'basepoint_x': 150000.0,
'basepoint_y': 150000.0,
'LC_lat1': 32.5,
'LC_lat2': 37.5
}
extrap = False
...
letkfoutdir = '/home/ra001011/a03471/data/output_data/LE_D1_5km/'
topofile = letkfoutdir + 'const/topo/topo'

stime = dt.datetime(2013,  7, 12,  12, 0, 0)
etime = dt.datetime(2013,  7, 12,  12, 0, 0)
