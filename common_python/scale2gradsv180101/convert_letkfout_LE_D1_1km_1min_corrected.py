...
vcoor = 'p'
hcoor = 'o'
plevels = [100000., 95000.,90000.,85000., 80000., 70000.,60000., 50000.,40000., 30000., 20000.]
...
letkfoutdir = '/home/ra001011/a03471/data/output_data/LE_D1_1km_1min/'
topofile = letkfoutdir + 'const/topo/topo'

stime = dt.datetime(2013,  7, 13,  5,   0, 0)
etime = dt.datetime(2013,  7, 13,  5,  17, 0)
tint = dt.timedelta(seconds=60)
