...
letkfoutdir = '/home/ra001011/a03471/data/output_data/OsakaPAR_1km_control1000m_smallrandompert_longloc/'
topofile = letkfoutdir + 'const/topo/topo'

stime = dt.datetime(2013,  7, 13,  5, 28, 00)
etime = dt.datetime(2013,  7, 13,  5, 30, 30)
